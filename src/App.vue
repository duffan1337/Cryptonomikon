...
export default {
  ...
  methods:{
    add(){
      ...
      setInterval(async()=>{
        const f = await fetch(
          `https://min-api.cryptocompare.com/data/price?fsym=${currentTicker.name}&tsyms=USDT&api_key=8fb7ea53b7d1118841edff36312ac66ebb8ee48189a16be1edbb8c3e4399c817`
          );
